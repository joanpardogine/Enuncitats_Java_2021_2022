...
public class App {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Entra la qtat de vertex que té el quadrat: ");
        qtatCostats = teclat.nextInt();

        if (qtatCostats != 4){
            System.out.println("ERROR!!! no pots crear un quadrat de " + qtatCostats + " vertex!");
        } else {
        ...
        Quadrat figuraQuadrada = new Quadrat(llistaDePunts);
